...
public class DrinksPagerAdapter extends PagerAdapter {
    Context context;
    int images[];
    int comboStyle = 0;
    int totVal  ;
    ...
    public DrinksPagerAdapter(Context context, int images[]) {
        ...
        normalBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(normalcount > 1){
                    ...
                    amtText.setText(String.valueOf(0));
                    comboName.setText("COOL DRINKS " +System.lineSeparator() +" INR "+ String.valueOf(100));
                }
        ...
        regularBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(regularCount > 1){
                    ...
                    amtText.setText(String.valueOf(0));
                    comboName.setText("COOL DRINKS " +System.lineSeparator() +" INR "+ String.valueOf(200));
                }
            }
        });
        ...
        largeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(largeCount > 1){
                    ...
                    amtText.setText(String.valueOf(0));
                    comboName.setText("COOL DRINKS " +System.lineSeparator() +" INR "+ String.valueOf(500));
                }
            }
        });

        comboName.setText("COOL DRINKS " +System.lineSeparator() +" INR "+ String.valueOf(00));
...
//                amtText.setText(String.valueOf(totamt));
                if(comboStyle == 1){
                    ...
                    if(regularCount >= 1 ) {
                        ...
                        amtText.setText(String.valueOf(regularCoutVal));
                        regularData = "COOL DRINKS " + System.lineSeparator() + " INR " + String.valueOf(amt);
                        comboName.setText(regularData);
                        ...
                        int amt = totamt * 200;
                        regularCoutVal = totamt;
                        comboName.setText("COOL DRINKS " + System.lineSeparator() + " INR " + String.valueOf(amt));
                        inrBtn.setText("REGULAR INR " + String.valueOf(amt));
                        regularTotal = "REGULAR INR: " + amt;
                    }
                    ...
                    if(largeCount >= 1 ) {
                        ...
                        amtText.setText(String.valueOf(largeCoutVal));
                        largeData = "COOL DRINKS " + System.lineSeparator() + " INR " + String.valueOf(amt);
                        comboName.setText(largeData);
                    ...
                    if(normalcount >= 1 ) {
                        ...
                        amtText.setText(String.valueOf(normalCoutVal));
                        normalData = "COOL DRINKS " + System.lineSeparator() + " INR " + String.valueOf(amt);
                        comboName.setText(normalData);
        ...
        inrBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                payDialogFragment.payAmt(inrBtn.getText().toString(),"COOL DRINKS",payVal);
                payDialogFragment.show( ((AppCompatActivity) context).getSupportFragmentManager(),payDialogFragment.getTag());
            }
        });
